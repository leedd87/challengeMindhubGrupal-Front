	...
	return (
        ...
        <article id="card">
          <header>
            ...
            <span id="nike" className="subhead">Nike</span>
          </header>
          ...
          <section>
            <div id="description">
              <span id="retail" className="subhead">Retail</span><span id="time" className="faded">2d ago</span>
            </div>
            <div id="location">
              <img src="https://image.flaticon.com/icons/svg/64/64113.svg" alt="" />
              <span className="faded">North America</span>
            </div>
            <div id="tags">
              <ul>
                <li>Advertising</li>
